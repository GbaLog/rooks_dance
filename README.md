...
* Фигуры ходят с места на место, а не по одной клетке(как в оригинальной игре),
* Вывод в консоль полностью не синхронизирован, поэтому могут появляться артефакты,
...
Как только пришло время сходить, она просит менеджера сходить.  
